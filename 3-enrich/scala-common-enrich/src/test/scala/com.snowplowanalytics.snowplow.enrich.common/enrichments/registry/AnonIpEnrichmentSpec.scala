...
class AnonIpEnrichmentSpec extends Specification with DataTables {
  ...
  def e1 =
    ...
    "valid, hash 4"          !! "94.15.213.171"   ! AnonOctets(4)        ! "58991e12616fe8996596bfa30004f643"     |
    "invalid, anonymize 1"   !! "777.2"           ! AnonOctets(1)        ! "777.2"                                |
    "invalid, anonymize 2"   !! "777.2.23"        ! AnonOctets(2)        ! "777.2.x"                                |
    "invalid, anonymize 3"   !! "999.123.777.2"   ! AnonOctets(3)        ! "999.x.x.x"                            |
    "invalid, anonymize 3"   !! "hello;goodbye"   ! AnonOctets(3)        ! "hello;goodbye"                        |
    "valid, hash 4"          !! "192.168.0.12"    ! AnonOctets(4)        ! "18ef1db49e789cf6d6fab4663bd7b8e4"     |
    "empty, anonymize 2"     !! null              ! AnonOctets(2)        ! null                                   |
    "empty, hash 4"          !! ""                ! AnonOctets(3)        ! ""                                     |> {
