...
class PageViewCfLineSpec extends Specification {
  ...
  "A job which processes a CloudFront file containing 1 valid page view event" should {
    EtlJobSpec("cloudfront", "1", true, List("geo", "isp")). // Anonymize 1 IP address quartet
