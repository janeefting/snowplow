...
object CampaignAttributionCfLineSpec {
  ...
  val expected = List(
    ...
    null,
    null,
    "http://www.psychicbazaar.com/2-tarot-cards/genre/native%20american/type/all/view/list?utm_source=Google%7CSearch&legacy_campaign=bad_campaign&utm_medium=utm_medium=cpc2&medium=bad_campaign&utm_term=native%20american%20tarot%20deck&utm_content=39254295088&source=bad_source&medium=bad_medium&legacy_term=bad_term&cid=uk-tarot--native-american&gclid=CI6thtbxhboCFTMctAod0FcAdQ",
    ...
    "utm_source=Google%7CSearch&legacy_campaign=bad_campaign&utm_medium=utm_medium=cpc2&medium=bad_campaign&utm_term=native%20american%20tarot%20deck&utm_content=39254295088&source=bad_source&medium=bad_medium&legacy_term=bad_term&cid=uk-tarot--native-american&gclid=CI6thtbxhboCFTMctAod0FcAdQ",
    null,
    "http",
    "www.google.com",
    "80",
    ...
    "cpc2",
    "Google|Search", //The %7C pipe is replaced by a double underscore
...
class CampaignAttributionCfLineSpec extends Specification {
  ...
  "A job which processes a CloudFront file containing 1 valid page ping with campaign attribution fields" should {
